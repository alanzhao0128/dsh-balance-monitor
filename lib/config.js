...
/** Default set of channels shown as fixed sidebar cards. */
export const CHANNEL_DEFAULT = ['deepseek-official', 'huoshan', 'commandcode']
...
export const Config = z.object({
  ...
  channels: z.object({
    ...
    enabled: z.array(z.string()).default(CHANNEL_DEFAULT),
  }),
  network: z.object({
