...
export const Config = z.object({
  ui: z.object({
    /** Whether the sidebar card renders at all. */
    showCard: z.boolean(),
    /** Sidebar card refresh interval (ms). */
    pollMs: z.number(),
    /** Provider-detection poll interval (ms). */
    providerPollMs: z.number(),
...
export function resolveConfig(config = {}) {
  const ui = {
    ...
    providerPollMs: config.ui?.providerPollMs ?? DEFAULTS.ui.providerPollMs,
